...
CREATE TABLE Fases_concluidas(Id serial PRIMARY KEY,idUsuario integer, Inicio Boolean DEFAULT FALSE, Fliperama BOOLEAN DEFAULT FALSE, Escola BOOLEAN DEFAULT FALSE, Supermercado BOOLEAN DEFAULT FALSE, Ambiental BOOLEAN DEFAULT FALSE, Sorveteria BOOLEAN DEFAULT FALSE, CONSTRAINT fk_idUsuario
